...
const (
	KeyService_GetKey_FullMethodName = "/key.KeyService/GetKey"
)
...
type KeyServiceClient interface {
	GetKey(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*KeyResponse, error)
}
...
func (c *keyServiceClient) GetKey(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*KeyResponse, error) {
...
type KeyServiceServer interface {
	GetKey(context.Context, *Empty) (*KeyResponse, error)
...
func (UnimplementedKeyServiceServer) GetKey(context.Context, *Empty) (*KeyResponse, error) {
...
func _KeyService_GetKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyServiceServer).GetKey(ctx, req.(*Empty))
	}
